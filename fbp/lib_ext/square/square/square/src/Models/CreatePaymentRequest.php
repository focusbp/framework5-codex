 ...
 *
 * For more information, see [Payments and Refunds APIs Overview](https://developer.squareup.
 * com/docs/payments-api/overview).
 *
 * For information about application fees in a payment, see
 * [Take Payments and Collect Fees](https://developer.squareup.com/docs/payments-api/take-payments-and-
 * collect-fees).
 */
