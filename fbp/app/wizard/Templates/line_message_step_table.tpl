<form id="wizard_line_message_table_form">
	<p style="font-size:13px;color:#374151;margin:0 0 8px 0;">{t key="wizard.line_message.table.description"}</p>
	...
	<div style="margin-top:12px;overflow:auto;">
		...
		<button type="button" class="ajax-link" invoke-function="submit_line_message_table_next" data-form="wizard_line_message_table_form" style="float:right;">{t key="common.next"}</button>
	</div>
</form>
