<form id="wizard_table_change_preview_form">
	<table style="width:100%;border-collapse:collapse;font-size:13px;margin-bottom:10px;">
		<tr>
			...
			<td style="border:1px solid #d5dbe5;padding:8px;">{t key="wizard.table_change.action.add_field"}</td>
		</tr>
		<tr>
		...
		<tr>
			<th style="text-align:left;border:1px solid #d5dbe5;background:#f4f7fb;padding:8px;">{t key="wizard.table_change.fields.label"}</th>
		...
		<tr>
			...
			<td style="border:1px solid #d5dbe5;padding:8px;">{$row.display_targets_text|escape}</td>
		</tr>
	</table>
