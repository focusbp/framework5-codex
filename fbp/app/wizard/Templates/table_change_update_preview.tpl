<form id="wizard_table_change_update_preview_form">
	<table style="width:100%;border-collapse:collapse;font-size:13px;margin-bottom:10px;">
		<tr>
			...
			<td style="border:1px solid #d5dbe5;padding:8px;">{t key="wizard.table_change.action.update_field"}</td>
		</tr>
		<tr>
		...
		<tr>
			<th style="text-align:left;border:1px solid #d5dbe5;background:#f4f7fb;padding:8px;">{t key="wizard.table_change.update_field.label"}</th>
			<td style="border:1px solid #d5dbe5;padding:8px;">{$row.fields_text|escape}</td>
		</tr>
		<tr>
			<th style="text-align:left;border:1px solid #d5dbe5;background:#f4f7fb;padding:8px;">{t key="wizard.table_change.update_field.change_text"}</th>
			<td style="border:1px solid #d5dbe5;padding:8px;white-space:pre-wrap;line-height:1.7;">{$row.update_field_change_text|escape}</td>
		</tr>
	</table>
	...
	<div style="margin-top:12px;overflow:auto;">
		<button type="button" class="ajax-link" invoke-function="back_to_table_change_update_field" style="float:left;">{t key="common.back"}</button>
