<form id="wizard_original_form_request_form">
	<p style="font-size:13px;color:#374151;margin:0 0 8px 0;">{t key="wizard.original_form.request.description"}</p>
	...
	<div style="margin-top:12px;overflow:auto;">
		<button type="button" class="ajax-link" invoke-function="back_to_original_form_place" style="float:left;">{t key="common.back"}</button>
		<button type="button" class="ajax-link" invoke-function="submit_original_form_request_next" data-form="wizard_original_form_request_form" style="float:right;">{t key="common.next"}</button>
	</div>
</form>
